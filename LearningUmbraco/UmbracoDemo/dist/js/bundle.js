...
var addressSearch = function addressSearch() {
	...
	window.AddressSearch = function () {
		...
		(0, _jquery2.default)(".address-search .search-box__submit").unbind("click");
		(0, _jquery2.default)(".address-search .search-box__submit").on("click", function (e) {

			e.preventDefault();
			var wrapper = (0, _jquery2.default)(this).parents().eq(2);
			var input = wrapper.find(".search-box__input");
			var postcode = input.val();

			if (postcode !== "") {
				wrapper.find(".dropdown__select").empty();
				_jquery2.default.get('/umbraco/api/addressapi/GetAddressList?postcode=' + postcode, function (response) {

					wrapper.find(".address-section").show();
					wrapper.find(".dropdown__select").append((0, _jquery2.default)('<option>').val('').text('Please Select'));

					for (var i = 0; i < response.PostPlaces.length; i++) {
						wrapper.find(".dropdown__select").append((0, _jquery2.default)('<option>').val(response.PostPlaces[i].Id).text(response.PostPlaces[i].StreetAddress));
					}

					wrapper.find(".dropdown__select").on("change", function () {

						var id = (0, _jquery2.default)(this).val();
						_jquery2.default.get('/umbraco/api/addressapi/GetFullAddress?addressId=' + id, function (data) {
...
var _pcaPostcodeLookup = __webpack_require__(12);

var _pcaPostcodeLookup2 = _interopRequireDefault(_pcaPostcodeLookup);
...
function defaultValidation(field) {
    ...
    if (typeof valtag !== 'undefined' && valtag !== null) {
        var msgError = valtag.getAttribute('data-message');
...
exports.default = defaultValidation;
...
var passwordStrength = function passwordStrength() {
    ...
    (0, _jquery2.default)('.password-validation').hide();

    //bind key up event
    (0, _jquery2.default)('#NewPassword_Password').keyup(function () {
        if ((0, _jquery2.default)('#NewPassword_Password').val() !== "") {
            (0, _jquery2.default)('.password-validation').show();
            (0, _jquery2.default)('#strength_value').html(checkStrength((0, _jquery2.default)('#NewPassword_Password').val()));
        } else {
            (0, _jquery2.default)('.password-validation').hide();
        }
    });
    ...
    function checkStrength(password) {
        ...
        if (strength < 2) {
            PowerReset();
            (0, _jquery2.default)('#strength_power_1').addClass('password-validation__bar-item--weak');
            return 'Weak';
        } else if (strength === 2) {
            PowerReset();
            (0, _jquery2.default)('#strength_power_1').addClass('password-validation__bar-item--weak');
            (0, _jquery2.default)('#strength_power_2').addClass('password-validation__bar-item--weak');
            return 'Weak';
        } else if (strength === 3) {
            PowerReset();
            (0, _jquery2.default)('#strength_power_1').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_2').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_3').addClass('password-validation__bar-item--strong');
            return 'Good';
        } else if (strength === 4) {
            PowerReset();
            (0, _jquery2.default)('#strength_power_1').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_2').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_3').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_4').addClass('password-validation__bar-item--strong');
            return 'Strong';
        } else {
            PowerReset();
            (0, _jquery2.default)('#strength_power_1').addClass('password-validation__bar-item--strong');
            ...
            (0, _jquery2.default)('#strength_power_3').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_4').addClass('password-validation__bar-item--strong');
            (0, _jquery2.default)('#strength_power_5').addClass('password-validation__bar-item--strong');
            return 'Strong';
        }
    }

    function PowerReset() {
        var indicators = document.querySelectorAll('.password-validation__bars');
...
var menuButtonIcon = document.querySelector(".fa-bars");

var showSubMenu = document.querySelector(".navigation__item-arrow");
var subMenu = document.querySelector(".navigation__sub-nav");
...
function menuSwitcher() {
    if (typeof menuButton !== 'undefined' && menuButton !== null) {
        ...
        showSubMenu.addEventListener("click", function (f) {
...
var filterButton = document.querySelector(".filter-dropdown__toggle");
var filterContent = document.querySelector(".filter-dropdown__content");
...
var showMore = document.querySelectorAll('.appointments__show-more');

var showMoreAppointments = function showMoreAppointments() {
...
exports.default = showMoreAppointments;
...
var _findNewAddress = __webpack_require__(2);

var _findNewAddress2 = _interopRequireDefault(_findNewAddress);

var _addressSearch = __webpack_require__(1);

var _addressSearch2 = _interopRequireDefault(_addressSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ajaxStuff = function ajaxStuff() {

	window.ajaxPostSuccess = function (response) {

		if (typeof response !== 'undefined' && response !== null) {

			var rhtml = $.parseHTML(response);
			...
			if (typeof targetId !== 'undefined' && targetId !== null) {
				...
				if (targetId == "UpdateMyDetailsAddress" || targetId == "UpdateNextOfKinTitleNameAddress") {
					(0, _findNewAddress2.default)();
					(0, _addressSearch2.default)();
				}
			}
		}
	};
...
var formStuff = function formStuff() {
    ...
    window.formEditCancel = function (e) {
        ...
        //other form is open
        var activeForms = document.querySelectorAll('.tabs-content__table-edit-content--edit-active');
    ...
    function storePreviousValues(formid) {
        initials = [];
        (0, _jquery2.default)('input,select', 'form').each(function () {
            if ((0, _jquery2.default)(this).closest('form')[0].id === formid) {
                initials.push({
                    formid: (0, _jquery2.default)(this).closest('form')[0].id,
                    type: (0, _jquery2.default)(this).attr('type'),
    ...
    function getPreviousValues(formid) {
        ...
        for (var i = 0; i < initials.length; i++) {
            if (initials[i].formid === formid) {
                (0, _jquery2.default)('input[type="' + initials[i].type + '"][name="' + initials[i].name + '"]', 'form').val(initials[i].value);
            }
        }
    }

    function resetFormValidation(formid) {
        var validator = (0, _jquery2.default)("#" + formid).validate();
        if (typeof validator !== 'undefined' && validator !== null) {
            validator.resetForm();
        }
        (0, _jquery2.default)(".field-validation-error").empty();
    }

    (0, _jquery2.default)(".tabs-content__table-edit").on("click", function (e) {
        formEditCancel(e);
    });

    //patient information search

    (0, _jquery2.default)(".patient-info-filter #cancel-search").on("click", function () {
        (0, _jquery2.default)(".filter-dropdown__search .input").val('');
        if ((0, _jquery2.default)(this).hasClass("mySpire-icon-cross")) {
            (0, _jquery2.default)(this).removeClass("mySpire-icon-cross");
            (0, _jquery2.default)(this).addClass("mySpire-icon-search");

            (0, _jquery2.default)(".filter-dropdown__toggle").removeClass("filter-dropdown__toggle--active");

            (0, _jquery2.default)(".filter-dropdown__content").removeClass("filter-dropdown__content--active");

            (0, _jquery2.default)(".filter-dropdown__list > li").each(function () {
                (0, _jquery2.default)(this).show();
            });
        }
    });

    (0, _jquery2.default)(".patient-info-filter .filter-dropdown__search .input").on("keyup", function () {

        var val = (0, _jquery2.default)(this).val();

        if ((0, _jquery2.default)("#cancel-search").hasClass("mySpire-icon-search")) {
            (0, _jquery2.default)("#cancel-search").removeClass("mySpire-icon-search");
            (0, _jquery2.default)("#cancel-search").addClass("mySpire-icon-cross");
        }

        (0, _jquery2.default)(".filter-dropdown__list > li").each(function () {
            if ((0, _jquery2.default)(this).text().search(val) > -1) {
                (0, _jquery2.default)(this).show();
            } else {
...
var _formAjaxPost = __webpack_require__(8);

var _formAjaxPost2 = _interopRequireDefault(_formAjaxPost);

var _formEditCancel = __webpack_require__(9);

var _formEditCancel2 = _interopRequireDefault(_formEditCancel);
...
var _showMoreAppointment = __webpack_require__(7);

var _showMoreAppointment2 = _interopRequireDefault(_showMoreAppointment);

var _showFilter = __webpack_require__(6);

var _showFilter2 = _interopRequireDefault(_showFilter);

var _passwordStrength = __webpack_require__(4);
...
(0, _formAjaxPost2.default)();

(0, _formEditCancel2.default)();

(0, _showMoreAppointment2.default)();

(0, _showFilter2.default)();
...
var _defaultValidation = __webpack_require__(3);
...
function resetValidation(field) {
    if (typeof field !== 'undefined' && field !== null) {
        var validation = (0, _defaultValidation2.default)(field);
...
exports.default = resetValidation;
...
var _resetValidation = __webpack_require__(11);

var _resetValidation2 = _interopRequireDefault(_resetValidation);

var _regexValidation = __webpack_require__(13);

var _regexValidation2 = _interopRequireDefault(_regexValidation);
...
function pcaPostcodeLookup(btnSearch, ddlContainer, ddlAddress, postcode, line1, line2, town) {
    ...
    if (typeof btnSearch !== 'undefined' && btnSearch !== null && typeof ddlContainer !== 'undefined' && ddlContainer !== null && typeof ddlAddress !== 'undefined' && ddlAddress !== null && typeof postcode !== 'undefined' && postcode !== null && typeof line1 !== 'undefined' && line1 !== null && typeof line2 !== 'undefined' && line2 !== null && typeof town !== 'undefined' && town !== null) {
        ...
        btnSearch.addEventListener('click', function (e) {
            ...
            if (postcode.value.length > 0) {
                ...
                postcodeRequest.open('GET', '/umbraco/api/addressapi/GetAddressList?postcode=' + postcode.value, true);
                //console.log(postcodeRequest);
                postcodeRequest.onload = function () {

                    //success
                    if (postcodeRequest.status === 200) {
                        var response = JSON.parse(postcodeRequest.responseText).PostPlaces;
                        if (response.length > 0) {
                            ...
                            for (var i = 0; i < response.length; i++) {
                                ...
                                addressOption.text = response[i].Place + (response[i].Place ? ", " : "") + response[i].StreetAddress;
        ...
        ddlAddress.addEventListener('change', function () {
            var lookupId = this.value;
            if (lookupId !== "" && lookupId !== null) {

                //request for address details
                var addressRequest = new XMLHttpRequest();
                addressRequest.open('GET', '/umbraco/api/addressapi/GetFullAddress?addressId=' + lookupId, true);
                addressRequest.onload = function () {

                    if (addressRequest.status === 200) {
                        var details = JSON.parse(addressRequest.responseText);
                        if (details != null) {
                            ...
                            //rest validations
                            (0, _resetValidation2.default)(line1);
                            (0, _resetValidation2.default)(line2);
                            (0, _resetValidation2.default)(town);
                            (0, _resetValidation2.default)(postcode);
                        }
                    } else {
                        searchError.innerHTML = "Serice error. Please enter your address manually.";
                    }
...
exports.default = pcaPostcodeLookup;
    ...
    if (typeof input !== 'undefined' && input !== null) {
        if (input.value.length > 0 && typeof pattern !== 'undefined' && pattern !== null) {
            ...
            if (!regex.test(input.value)) {
                var valTag = (0, _defaultValidation2.default)(input);
                if (typeof valTag !== 'undefined' && valTag !== null) {
